# AptosAI - Talk to the  Blockchain with AI

AptosAI is a conversational web app that allows users to interact with the any Blockchain using natural language  just like talking to ChatGPT.

Built with **Next.js**, **Vercel AI SDK**, **Google Gemini**, AptosAI makes blockchain interactions simple, accessible, and developer-friendly.
...
```bash
git clone https://github.com/rishi-xyz/aptosai.git
cd aptosai
```
